...
const Weather = () => {
  ...
  return (
    ...
    >
      ...
      { (weather || error) && <div className="mt-8 w-full max-w-md px-4 py-1 bg-white bg-opacity-80 rounded-lg shadow-lg">
        {weather && (
          <label className="inline-flex w-full items-center cursor-pointer mt-4   justify-end">
        ...
        {error && (
          <p className="text-red-500 mt-4 mb-4 w-full text-center">{error}</p>
        )}
          ...
          <div className="mt-4 bg-white p-6 rounded-md shadow-md">
            ...
            <div className="flex flex-col items-center md:flex-row md:items-start mt-5">
              <div className="ml-0  w-full">
                ...
                <div className="flex justify-center gap-12 mt-2 mb-4">
                  <div>
                    <p>
                      <strong>Min:</strong>{" "}
              ...
              {forecast.map((day, index) => (
                <div key={index} className="border p-5 rounded-md shadow-sm">
                  ...
                  <p>
                    ...
                    {convertTemperature(day.temp).toFixed(1)} °
                    {unit === "metric" ? "C" : "F"}
                  </p>
                  <p>
